...
public class Shui {
	...
	public static void main(String[] args) {
		...
		{
			System.out.println("所需要缴纳的税费为："+((salary-55000)*0.35+1500*0.03+3000*0.1+4500*0.2+24000*0.25+20000*0.3));
			
		}
		if(salary>80000)
		{
			System.out.println("所需要缴纳的税费为："+((salary-80000)*0.45+1500*0.03+3000*0.1+4500*0.2+24000*0.25+20000*0.3+25000*0.35));
